...
HD_PWD='C:/Users/26041/Desktop/Math Logic/Projects/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log voter_plus.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source voter_plus.tcl -notrace
