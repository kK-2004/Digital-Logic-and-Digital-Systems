...
HD_PWD='C:/Users/26041/Desktop/Math Logic/Projects/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log voter_plus.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source voter_plus.tcl
