...
HD_PWD='C:/Users/26041/Desktop/Math Logic/Projects/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log voter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source voter.tcl -notrace
