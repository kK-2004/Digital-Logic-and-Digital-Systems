...
HD_PWD='C:/Users/26041/Desktop/Math Logic/Projects/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log voter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source voter.tcl
